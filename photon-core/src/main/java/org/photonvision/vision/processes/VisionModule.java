...
public class VisionModule {
    ...
    static void applyCameraSettingsForPipeline(
        ...
        // Prime lastExposureRaw before switching to manual mode so first-boot camera quirks can
        // re-apply the saved exposure during their auto/manual toggle sequence.
